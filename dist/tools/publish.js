...
import { getPublishStatus, publishPhotos, publishVideo, } from "../lib/tiktok/publish.js";
...
export function registerPublishTools(server) {
    server.tool("tiktok_publish_photos", "Publish a photo carousel post to TikTok via official Content Posting API v2 (PULL_FROM_URL).", {
        ...
        post_mode: PostModeSchema.default("MEDIA_UPLOAD").describe("MEDIA_UPLOAD = drafts to creator inbox for review; DIRECT_POST = publishes directly live to feed."),
        privacy_level: PrivacyLevelSchema.default("PUBLIC_TO_EVERYONE").describe("Visibility: PUBLIC_TO_EVERYONE, MUTUAL_FOLLOW_FRIENDS, FOLLOWER_OF_CREATOR, or SELF_ONLY."),
        photo_cover_index: z
            .number()
            .int()
            .min(0)
            ...
            content: [
                {
                    ...
                    text: JSON.stringify({
                        success: true,
                        message: options.post_mode === "MEDIA_UPLOAD"
    ...
    server.tool("tiktok_publish_video", "Publish a video to TikTok via official Content Posting API v2 (PULL_FROM_URL).", {
        ...
        post_mode: PostModeSchema.default("MEDIA_UPLOAD").describe("MEDIA_UPLOAD = drafts to inbox; DIRECT_POST = publishes directly to profile."),
        privacy_level: PrivacyLevelSchema.default("PUBLIC_TO_EVERYONE").describe("Visibility: PUBLIC_TO_EVERYONE, MUTUAL_FOLLOW_FRIENDS, FOLLOWER_OF_CREATOR, or SELF_ONLY."),
    ...
    server.tool("tiktok_publish_status", "Check processing and publishing status of a TikTok post by publish_id.", {
        profile: z.string().default(DEFAULT_PROFILE).describe("Profile name."),
